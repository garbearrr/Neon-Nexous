...
import TDUI from "../3Duitest";
import { Money } from "client/modules/Money/Money";
import { BigNumber } from "shared/modules/BigNumber/BigNumber";

const Player = Players.LocalPlayer;
const PlayerGui = Player.WaitForChild("PlayerGui") as StarterGui;
const ThreeDeeUI = PlayerGui.WaitForChild("ThreeDUI") as StarterGui["ThreeDUI"];

const ShopFrame = ThreeDeeUI.MainFrame.Scanlines.Shop;

class ShopMenuGrid extends BaseItemMenuGrid {
    protected DescFrame: typeof ShopFrame["3_Content"]["3_Desc"];
    ...
    public constructor(Frame: typeof ShopFrame) {
        ...
        this.DescFrame = Frame["3_Content"]["3_Desc"];
        this.PopulateMenu();
    }
...
TDUI.AddPage("Shop", new ShopMenuGrid(ShopFrame));
