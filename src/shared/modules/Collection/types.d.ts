type Keep<V> = { keep: false } | { keep: true; value: V };

interface ICollection<K, V> {
    Events: {
        OnAdd: IEvent<{Key: K, Value: V}>;
    }
	/**
	 ...
	 */
	Clone(): ICollection<K, V>;
	/**
	 * Merges the current collection with one or more other collections.
	 */
	Concat(...collections: ICollection<K, V>[]): ICollection<K, V>;
	/**
	 ...
	 */
	Difference(collection: ICollection<K, V>): ICollection<K, V>;
	/**
	 * Retrieves the value associated with the specified key from the collection.
	 */
	Each(fn: (value: V, key: K) => void): ICollection<K, V>;
	/**
	 ...
	 */
	Equals(collection: ICollection<K, V>): boolean;
	/**
	 ...
	 */
	Filter(fn: (value: V, key: K) => boolean): ICollection<K, V>;
	/**
	 ...
	 */
	Intersect(collection: ICollection<K, V>): ICollection<K, V>;
	/**
	 ...
	 */
	MapValues(fn: (value: V, key: K) => V): ICollection<K, V>;
	/**
	 ...
	 */
	Partition(fn: (value: V, key: K) => boolean): [ICollection<K, V>, ICollection<K, V>];
	/**
	 ...
	 */
    Sort(fn: (a: V, b: V) => number): ICollection<K, V>;
	/**
	 ...
	 */
	Tap(fn: (collection: ICollection<K, V>) => void): ICollection<K, V>;
	/**
	 * Converts the collection into an array of its values.
	 */
	ToJSON(): V[];
